...
<div class="row">
    <div class="col-12">
        <div class="card">
            <div class="card-body">
                <h4 class="header-title mb-4">Informasi Proyek</h4>
                ...
                <form method="POST" action="">
                        ...
                        <div class="col-lg-6">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" id="name" name="name" required
                                       ...
                                       placeholder="Contoh: Renovasi Ruko Jl. Malioboro">
                            </div>
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" id="project_code" name="project_code"
                                       value="<?= sanitize($_POST['project_code'] ?? '') ?>"
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" id="region_name" name="region_name"
                                       value="<?= sanitize($_POST['region_name'] ?? '') ?>"
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" id="activity_name" name="activity_name"
                                       value="<?= sanitize($_POST['activity_name'] ?? '') ?>"
                                       placeholder="Nama kegiatan resmi">
                            </div>
                            
                            <div class="mb-3">
                                <label for="work_description" class="form-label">Pekerjaan</label>
                                <textarea class="form-control" id="work_description" name="work_description" rows="2"
                                          placeholder="Deskripsi pekerjaan"><?= sanitize($_POST['work_description'] ?? '') ?></textarea>
                            </div>
                            
                            <div class="mb-3">
                                <label for="description" class="form-label">Keterangan Tambahan</label>
                                <textarea class="form-control" id="description" name="description" rows="2"
                                          placeholder="Catatan tambahan"><?= sanitize($_POST['description'] ?? '') ?></textarea>
                            </div>
                        </div>
                        ...
                        <div class="col-lg-6">
                            ...
                            <div class="row">
                                <div class="col-md-6 mb-3">
                                    ...
                                    <input type="text" class="form-control" id="funding_source" name="funding_source"
                                           value="<?= sanitize($_POST['funding_source'] ?? '') ?>"
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    <input type="number" class="form-control" id="budget_year" name="budget_year"
                                           value="<?= sanitize($_POST['budget_year'] ?? date('Y')) ?>"
                                           min="2020" max="2100">
                                </div>
                            </div>
                            ...
                            <div class="row">
                                <div class="col-md-6 mb-3">
                                    ...
                                    <input type="text" class="form-control" id="contract_number" name="contract_number"
                                           value="<?= sanitize($_POST['contract_number'] ?? '') ?>">
                                </div>
                                <div class="col-md-6 mb-3">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" id="service_provider" name="service_provider"
                                       value="<?= sanitize($_POST['service_provider'] ?? '') ?>"
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" id="supervisor_consultant" name="supervisor_consultant"
                                       value="<?= sanitize($_POST['supervisor_consultant'] ?? '') ?>"
                    ...
                    <div class="d-flex gap-2">
                        <button type="submit" class="btn btn-primary">
                            <i class="mdi mdi-content-save"></i> Simpan & Lanjut ke RAB
                        </button>
